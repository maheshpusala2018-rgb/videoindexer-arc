...
param networkSecurityGroupNameCloud string = 'Cbintel-NSG-Prod'

@description('Name of the Bastion Network Security Group')
param bastionNetworkSecurityGroupName string = 'Cbintel-NSG-Bastion'
...
var bastionName = 'CbIntel-Bastion'
